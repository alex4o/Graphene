...
var dialogue = [
	{
		...
		array: [
			...
			{ //loc: 10
				who: "Карбон",
				say: "Сигурно те е страх, че не можеш да нокажеш нищо кой знае какво!",
				loc: 11
			},
			{ //loc: 11
				who: "Графен",
			...
			{ //loc: 16
				who: "Карбон",
				say: "Почуствах се застрашен. Не искам да повярвам чи има по-ползна взриация на въглерода.",
				loc: 17
			},			
			{ //loc: 17
				who: "Карбон",
			...
			{ //loc: 21
				who: "Графен",
				say: "С моята невероятната здравина от 1100 GPa ще спра метеорит летящ към земята",
				loc: 13 
			},
		]
	},
	{
		...
		array: [
			...
			{ //loc: 2
				who: "Карбон",
				say: "Да видим другите свойства тогава.",
				loc: 3
			},
			{ //loc: 3
				who: "Графен",
	...
	},
	{
		...
		array: [
			{ //loc: 0
				who: "Карбон",
				say: "Какво можеш толкова благодарение на твойята ",
				loc: 1
			},
			{ //loc: 1
				who: "Графен",		
				answer: [
					{ say: "Електропроводимост от 1738 siemens/m", loc: 2 },
					{ say: "Енергийна плътност от 75 F/g и 31·9 Wh/kg", loc: 3 }
				]
			},
			{ //loc: 2
				who: "Графен",
		...
		array: [
			{ //loc: 0
				who: "Графен",
				say: "A също бaтерия направена от мен има в пъти издражливостта на нормална батерия",
	...
	},
	{
		...
		array: [
			{
				who: "Карбон",
				say: "... добре признавам че си по-полезен",
				scene: "end_true"
			}
		]
	},
