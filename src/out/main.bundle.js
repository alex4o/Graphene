...
/***/ function(module, exports, __webpack_require__) {
	...
	var _jqueryMagnificPopup = __webpack_require__(768);
	
	var _jqueryMagnificPopup2 = _interopRequireDefault(_jqueryMagnificPopup);
	...
	window.mp = _jqueryMagnificPopup2.default;
	/*
	...
	*/
	...
	(0, _jquery2.default)(document).ready(function () {
		...
		if (window.location.hash) {
			(0, _jquery2.default)("body, html").animate({
				scrollTop: (0, _jquery2.default)(window.location.hash).offset().top
			}, 1000);
		}
	
		(0, _jquery2.default)(".thumb").attr("src", function () {
		...
		(0, _jquery2.default)("#scroll-arrow").click(function () {
			(0, _jquery2.default)("body, html").animate({
				scrollTop: (0, _jquery2.default)((0, _jquery2.default)(this).attr("href")).offset().top
			}, 800);
			return false;
		});
	...
	var video = (0, _jquery2.default)("#vid-box-vid");
	var box = (0, _jquery2.default)("#vid-box");
	...
	(0, _jquery2.default)(".demo").click(function () {
		showVideo(table[(0, _jquery2.default)(this).data("type")]);
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;/* WEBPACK VAR INJECTION */(function(__webpack_provided_window_dot_jQuery) {/*! Magnific Popup - v1.1.0 - 2016-02-20
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!./../../raw-loader/index.js!./../../postcss-loader/index.js!./magnific-popup.css", function() {
				var newContent = require("!!./../../raw-loader/index.js!./../../postcss-loader/index.js!./magnific-popup.css");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
